                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md 12 d-flex justify-content-start mt-2" title="{{ __('Ažurirajte: Objavljeni naučni radovi') }}">
                                    <a href="#" class="m-0 ml-3"> <small> Pitanje je prvi puta korišteno na kvizu 03.05.2023 godine. </small> </a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md 12 d-flex justify-content-start mt-2" title="{{ __('Ažurirajte: Objavljeni naučni radovi') }}">
                                    <a href="#" class="m-0 ml-3"> <small> <i class="fas fa-times"></i> 26 netačnih odgovora </small> </a>
                                </div>
                            </div>
                        </div>
                    </div>
